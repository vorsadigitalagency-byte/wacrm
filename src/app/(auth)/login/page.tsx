            ...
            {!inviteToken ? (
              <>    
                ...
                <p className="mt-1 text-sm text-muted-foreground">
                  WhatsApp Inbox That Grows Your Business
                </p>
              </>
            ) : (
          ...
          <CardContent>
              ...
              <div className="flex flex-col gap-2">
                <div className="flex items-center justify-between">
                  ...
                  <Link
                    ...
                    className={`text-sm ${brandLinkClass}`}
                  >
                    Forgot password?
                  </Link>
                </div>
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              >
                <Button
                  type="button"
                  className={`h-10 w-full font-semibold uppercase tracking-wide ${brandButtonClass}`}
                >
                  Create account
                </Button>
              </Link>
